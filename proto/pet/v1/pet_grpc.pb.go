...
const (
	PetStore_GetPet_FullMethodName    = "/pet.v1.PetStore/GetPet"
	PetStore_PutPet_FullMethodName    = "/pet.v1.PetStore/PutPet"
	PetStore_DeletePet_FullMethodName = "/pet.v1.PetStore/DeletePet"
)
...
func (c *petStoreClient) PutPet(ctx context.Context, in *PutPetRequest, opts ...grpc.CallOption) (*PutPetResponse, error) {
	...
	err := c.cc.Invoke(ctx, PetStore_PutPet_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PetStore_PutPet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: PetStore_PutPet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
